package com.dv.translatorthoaikx;
...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"From","English","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech", "Welsh", "Hindi", "Urdu","Vietnam","Japan"};

    String[] toLanguages = {"To","English","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech", "Welsh", "Hindi", "Urdu","Vietnam","Japan"};
